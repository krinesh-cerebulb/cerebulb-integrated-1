          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            <div className="lg:w-1/2">
              ...
              <p className="text-lg mb-8">
                We work closely with our clients to understand their goals and objectives. Our team assists in developing a robust project plan, defining project scope, setting realistic timelines, and establishing key milestones.
              </p>
              <a
                href="/contact"
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="md:w-1/2">
              ...
              <p className="mb-4 text-gray-700">
                At Humac, we will help you build efficient project teams by identifying the right talent and assigning roles and responsibilities. Our project managers excel in team coordination, fostering collaboration, and maintaining effective communication channels.
              </p>
